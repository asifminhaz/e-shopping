...
.catch(error => console.log(error))
  ...
  <div className="navbar-start ">
    <div className="dropdown">
      ...
      <ul tabIndex={0} className="menu menu-sm dropdown-content mb-28 z-10 p-2  shadow bg-base-100 rounded-box w-52 ">
        {navOptions}
      </ul>
    </div>
  ...
  <div className="navbar-end">
    {
      user? <>
      <button onClick={handleLogOut} class="btn btn-outline btn-primary btn-sm">Log out</button>
       </> : <><button class="btn btn-outline btn-primary btn-sm" ><Link to="/login">Log In</Link></button> </>
    }
